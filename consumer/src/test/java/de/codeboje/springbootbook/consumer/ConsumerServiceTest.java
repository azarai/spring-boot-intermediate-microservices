...
@RestClientTest(value = CommentService.class)
public class ConsumerServiceTest {
	...
	public void whenGetComments_thenReturnEmpty() {
		...
		this.server.expect(requestTo("https://commentstore/list/" + productId))
	...
	public void whenGetComments_thenReturnError() {
		...
		final String productId = "product4712";
		this.server.expect(requestTo("https://commentstore/list/" + productId)).andRespond(withServerError());
